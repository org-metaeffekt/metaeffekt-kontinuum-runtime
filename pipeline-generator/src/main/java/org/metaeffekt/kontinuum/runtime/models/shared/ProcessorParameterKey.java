...
public enum ProcessorParameterKey {
    ...
    PARAM_ASSET_HEADER_NAME("param.asset.header.name"),
    PARAM_ASSET_HEADER_VALUE("param.asset.header.value"),
    PARAM_ASSET_ID("param.asset.id"),
    PARAM_ASSET_NAME("param.asset.name"),
    PARAM_ASSET_PASSWORD("param.asset.password"),
    PARAM_ASSET_TOKEN("param.asset.token"),
    PARAM_ASSET_URL("param.asset.url"),
    PARAM_ASSET_USERNAME("param.asset.username"),
