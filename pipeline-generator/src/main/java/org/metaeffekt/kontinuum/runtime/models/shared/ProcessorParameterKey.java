...
public enum ProcessorParameterKey {
    ...
    PARAM_HEADER_NAME("param.header.name"),
    PARAM_HEADER_VALUE("param.header.value"),
    ...
    PARAM_CLASSIFIER("param.classifier"),
    ...
    PARAM_FAIL_ON_MISSING_SOURCES("param.fail.on.missing.sources"),
    ...
    PARAM_REFERENCE_COMPONENTS_DIR("param.reference.components.dir"),
    ...
    PARAM_REFERENCE_LICENSES_DIR("param.reference.licenses.dir"),
    ...
    PARAM_TARGET_COMPONENTS_DIR("param.target.components.dir"),
    PARAM_TARGET_LICENSES_DIR("param.target.licenses.dir"),
